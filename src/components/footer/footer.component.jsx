...
const Footer = () => {
    return (
        <footer classNameName="footer mt-auto" data-a="" id="footerTag">
            <div classNameName="container border-bottom d-lg-block" data-a="">
                <div
                    classNameName="d-grid px-2 px-0 pt-6 text-center text-lg-start"
                    id="footerGrid"
                    style={{ gridTemplateColumns: "1fr 1fr 1fr 3fr ", gap: "16px" }}
                    data-a=""
                >
                    <div data-a="">
                        <h4 
                            // classNameName="text-3 font-bold mt-2" 
                            id="alibabaPart" data-a="">
                            علی بابا
                        </h4>
                        <ul 
                            classNameName="d-list-none m-0 p-0" 
                            id="alibaba"
                            data-a="">
                            <li classNameName="mb-2" data-a="">
                                <a classNameName="footer-link" href="#about" data-a="">
                                    درباره ما
                                </a>
                            </li>
                            <li classNameName="mb-2" data-a="">
                                <a
                                    classNameName="footer-link"
                                    aria-current="page"
                                    href="#help-center"
                                    data-a=""
                                >
                            ...
                            <li classNameName="mb-2" data-a="">
                                <a classNameName="footer-link" href="#why-alibaba" data-a="">
                                    چرا علی بابا
                                </a>
                            </li>
                            <li classNameName="mb-2" data-a="">
                                <a classNameName="footer-link" href="#plus" data-a="">
                                    علی بابا پلاس
                                </a>
                            </li>
                            <li classNameName="mb-2" data-a="">
                                <a classNameName="footer-link" href="#insurance" data-a="">
                                    بیمه مسافرتی
                                </a>
                            </li>
                            <li classNameName="mb-2" data-a="">
                                <a classNameName="footer-link" href="#mag" data-a="">
                                    مجله علی بابا
                                </a>
                            </li>
                        </ul>
                    ...
                    <div data-a="">
                        <h4 
                            className="text-3 font-bold mt-2"
                            id="service"
                            data-a="">
                            خدمات مشتریان
                        </h4>
                        <ul 
                            className="d-d-list-none m-0 p-0" 
                            id="customers"
                            data-a="">
                            <li className="mb-2" data-a="">
                                <a
                                    href="#help-center"
                            ...
                            <li className="mb-2" data-a="">
                                <a href="#purchase-guide" className="footer-link" data-a="">
                                    راهنمای خرید
                                </a>
                            </li>
                            <li className="mb-2" data-a="">
                                <a href="#refund-guide" className="footer-link" data-a="">
                                    راهنمای استرداد
                                </a>
                            </li>
                            <li className="mb-2" data-a="">
                                <a href="#general-policy" className="footer-link" data-a="">
                                    قوانین و مقررات
                                </a>
                            </li>
                            <li className="mb-2" data-a="">
                                <a href="#faq" className="footer-link" data-a="">
                                    پرسش و پاسخ
                                </a>
                            </li>
                        </ul>
                    ...
                    <div data-a="">
                        ...
                        <ul 
                            ...
                            data-a="">
                            <li className="mb-2" data-a="">
                                <a href="#loyalty" className="footer-link" data-a="">
                                    باشگاه همسفران
                                </a>
                            </li>
                            <li className="mb-2" data-a="">
                                <a href="#business" className="footer-link" data-a="">
                                    فروش سازمانی
                                </a>
                            </li>
                            <li className="mb-2" data-a="">
                            ...
                            <li className="mb-2" data-a="">
                                <a href="#jobs" className="footer-link" data-a="">
                                    فرصت‌های شغلی
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div className="footer__business-logos text-left" data-a="">
                        <h4 className="sr-only" data-a="">
                            {" "}
                            اطلاعات تماس{" "}
                        </h4>
                        <img
                            ...
                            alt="Alibaba Logo"
                            className="is-responsive is-animated block mb-5 mr-auto"
                            height="30"
                            data-a=""
                        />
                        <address className="text-3 text-grays-600 mb-7" data-a="">
                            <p className="mb-3" data-a="">
                                {" "}
                                تلفن پشتیبانی:
                                <a
                                    dir="ltr"
                                    className="font-medium mr-3"
                                    href="tel:02143900000"
                                    data-a=""
                                >
                                    ۰۲۱ - ۴۳۹۰۰۰۰۰{" "}
                                </a>
                            </p>
                            <span className="block text-grays-500" data-a="">
                                {" "}
                        ...
                        <ul 
                            ...
                            id="icons"
                            data-a="">
                            <li className="d-inline-block" data-a="">
                                <a
                            ...
                            <li className="d-inline-block" data-a="">
                                ...
                                >
                                    <img
                                        src="../../assets/ENAMADpng.parspng.com_.png"
                                        alt="ای‌نماد"
                                        className="is-responsive is-animated"
                                        height="69"
                                        width="69"
                            ...
                            <li className="d-inline-block" data-a="">
                                <a className="card-footer p-1" href="http://www.aira.ir/" data-a="">
                                    <img
                            ...
                            <li className="d-inline-block" data-a="">
                                <a className="card-footer p-1" href="https://caa.gov.ir/" data-a="">
                                    <img
                ...
                <div
                    // className="position-relative text-right absolute right-0 -top-[10px] max-w-[36rem]"
                    className="position-relative"
                    id="moreLinks"
                    data-a=""
                >
                    <div 
                        className="text-truncate position-absolute bottom-0 start-0"
                        id="truncate"
                        >
                        <a href="/charter-ticket" className="text-grays-400 text-2">
                            بلیط چارتر
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/tour/iran-kish_island" className="text-grays-400 text-2">
                            تور کیش
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/tour/turkey-istanbul" className="text-grays-400 text-2">
                            تور استانبول
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/accommodation/all-cottage" className="text-grays-400 text-2">
                            اجاره کلبه جنگلی
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/train-ticket" className="text-grays-400 text-2">
                            بلیط قطار
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/iranout" className="text-grays-400 text-2">
                            خرید بلیط هواپیما خارجی
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/flight-info" className="text-grays-400 text-2">
                            اطلاعات فرودگا‌هی
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a
                            href="#passenger-rights"
                            className="text-grays-400 text-2"
                            rel="noopener"
                        >
                            شیوه‌نامه حقوق مسافر
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/hotel" className="text-grays-400 text-2">
                            رزرو هتل
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/hotel/ir-mashhad" className="text-grays-400 text-2">
                            هتل مشهد
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/hotel/ir-kish" className="text-grays-400 text-2">
                            هتل کیش
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a
                            href="/hotel/ir-mashhad/mashhad-darvishi"
                            className="text-grays-400 text-2"
                        >
                            هتل درویشی مشهد
                        </a>
                        <span className="dot md:mx-3"></span>
                        <a href="/hotel/ir-kish/kish-shaygan" className="text-grays-400 text-2">
                            هتل شایگان کیش
                        </a>
                    </div>
                    <button
                        type="button"
                        className="btn is-md is-link absolute mt-2 md:text-2 top-full right-0"
                        id="more_btn"
                    >
            ...
            <div className="container pb-5" data-a="">
                <hr className="divider my-5" aria-hidden="true" />
                <div 
                    // className="d-flex items-center justify-between"
                    id="lastElements">
                    <small 
                        className="text-2 text-grays-400"
                        id="smallText">
                        {" "}
                        کلیه حقوق این سرویس (وب‌سایت و اپلیکیشن‌های موبایل) محفوظ و متعلق به
                        شرکت سفرهای علی‌بابا می‌باشد. <span dir="ltr"> (نسخه 2.36.3) </span>
                    </small>
                    <div className="text-center"
                        id="logos">
                        <a
                            href="#AlibabaTravels"
                            className="text-grays-400 hover:text-blue-600 d-inline-block align-middle text-center w-5 mx-4"
